...
//        }
        ...
        return $this->render('question/create.html.twig', ['maform'=>$form->createView(),'helo'=>$helo]);
        //
...
//        $query=$repo->findBy([],['updatedAt'=>'DESC']);
        ...
        return $this->render('question/homepage.html.twig', ['helos' => $pagination,'tags'=>$tags,'alltags'=>$alltags ]);
...
//        $query=$repo->findBy([],['updatedAt'=>'DESC']);
        ...
        return $this->render('question/searchwithtags.html.twig', ['helos' => $pagination,'tags'=>$tags,'alltags'=>$alltags,'tagtitle'=>$tagtitle,'keyword'=>$q ]);
    ...
    public function showa(Helo $helo,HeloRepository $repo , $id)
    {
        ...
        if($helo)
        {
            return $this->render('question/show.html.twig', ['helo' => $helo]);
        }
       else
       {
...
//        }
    ...
    /**
     * @Route("/questions/search" , name="app_search" )
     */
    public function search(Request $request ) : Response
    {
        ...
        return $this->render('question/service.html.twig', ['form'=>$form->createView()]);
    }
     ...
     * @return Response
     * @Security("is_granted('ROLE_USER') && user.isVerified() ")
     * @Route("/questions/show/{id<\d+>}/like" , name="app_pin_like" )
     */
    ...
    /**
     * @Route("/questions/show/{id<\d+>}/comment" , name="app_pin_comment" )
     */
...
//        }
     ...
     * @return Response
     * @Security("is_granted('ROLE_USER') && user.isVerified() ")
     * @Route("/questions/show/{id<\d+>}/dislike" , name="app_pin_dislike" )
     */
     ...
     * @Route("/questions/profile/{id<\d+>}",name="app_show_profile")
     */
 ...
 * @return Response
 * @Security("is_granted('ROLE_USER') && user.isVerified()")
 * @Route("/questions/show/{id<\d+>}/comment/delete/{cm<\d+>}" , name="app_delete_comment" )
 */
public function deletecomment(Helo $helo,PostCommentRepository $postComment,$id,$cm,EntityManagerInterface $manager) :Response
{
    ...
    /**
     *  @param EntityManagerInterface $manager
     * @Route("/questions/profile/{id<\d+>}/follow" , name="app_profile_follow" )
     */
    ...
    /**
     * @Route("/questions/shows/{id}/references",name="upload_reference",methods={"POST"})
     * @IsGranted("ROLE_USER")
     */
...
//        return $this->redirectToRoute('app_edit',['id'=>$helo->getId()]);
    ...
    /**
     * @Route ("/questions/shows/{id<\d+>}/references",name="app_list_refernces")
     */
    ...
    /**
     * @Route("/questions/shows/references/{id<\d+>}/download",name="download_file")
     */
...
//       return $response;
    ...
    /**
     * @Route("/questions/shows/references/{id}", name="app_reference_delete", methods={"DELETE"})
     */
    ...
    /**
     * @Route("/questions/shows/myPosts",name="app_my_posts")
     * @IsGranted("ROLE_USER")
     */
    public function list(HeloRepository $repo,PaginatorInterface $paginator,Request $request) : Response
    {
       ...
       return $this->render('question/showmyposts.html.twig',['helos'=>$helos]);
    }
    /**
     * @Route("/questions/shows/myPosts/{id<\d+>}/publish",name="app_publish")
     * @IsGranted("ROLE_USER")
     */
