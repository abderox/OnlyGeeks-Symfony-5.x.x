...
class MessageController extends AbstractController
{
     ...
     * @throws \Exception
     */
    public function newMessage(Request $request, Conversation $conversation, SerializerInterface $serializer , MessageBusInterface $bus )
    {
        $user = $this->getUser();
        $users = $this->userRepository->findOneBy(['id'=>1450]);
